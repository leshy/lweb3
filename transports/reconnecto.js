...
(function(){
  var Backbone, h, core, _, memBuffer, memBufferDropper, reconnecto;
  ...
  memBufferDropper = exports.memBufferDropper = Backbone.Model.extend4000({
    initialize: function(){
      this.buffer = [];
      return this.size = this.get('size') || 1000;
    },
    push: function(it){
      this.buffer.push(it);
