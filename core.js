...
(function() {
  var Backbone, _, channel, core, helpers, motherShip, protocol, protocolHost, server, startTime, subscriptionMan, v, validator,
    slice = [].slice;
    ...
    initialize: function() {
      ...
      return this.when('parent', (function(_this) {
        return function(parent) {
          var ref;
          _this.parent = parent;
          return _this.verbose = _this.get('verbose') || ((ref = _this.parent) != null ? ref.verbose : void 0) || false;
        };
      })(this));
    },
    name: function() {
