...
(function() {
  var Backbone, _, channel, channelClass, channelHost, core, h, helpers, motherShip, protocol, protocolHost, server, startTime, subscriptionMan, v, validator,
    slice = [].slice;
  ...
  channelHost = exports.channelHost = Backbone.Model.extend4000({
    initialize: function() {}
  }, !this.defaultChannelClass ? this.defaultChannelClass = this.get('defaultChannelClass') : void 0, (channelClass = this.get('channelClass') || this.channelClass) ? this.channelClass = this.defaultChannelClass.extend4000(channelClass) : this.channelClass = this.defaultChannelClass);
