...
(function() {
  var Backbone, _, async, channel, client, clientCollection, collectionInterface, collectionProtocol, colors, core, h, helpers, query, queryToCallback, server, serverCollection, serverServer, subscriptionMan, v, validator;
