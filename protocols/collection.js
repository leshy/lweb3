...
(function() {
  var Backbone, async, channel, client, clientCollection, collectionInterface, collectionProtocol, colors, core, helpers, query, queryToCallback, server, serverCollection, serverServer, subscriptionMan, v, validator, _;
