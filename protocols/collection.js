...
(function() {
  var Backbone, async, channel, client, clientCollection, collectionInterface, collectionProtocol, colors, core, h, helpers, query, queryToCallback, server, serverCollection, serverServer, subscriptionMan, v, validator, _;
      ...
      return this.when('parent', (function(_this) {
        return function(parent) {
          return parent.parent.onQuery({
            ...
            if (msg.call && ((_ref = msg.pattern) != null ? _ref.constructor : void 0) === Object) {
