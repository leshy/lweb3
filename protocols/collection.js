...
(function() {
  var Backbone, _, async, channel, client, clientCollection, collectionInterface, collectionProtocol, core, helpers, query, queryToCallback, server, serverCollection, serverServer, subscriptionMan, v, validator;
